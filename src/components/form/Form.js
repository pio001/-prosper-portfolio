...
function Form() {
    ...
    function sendEmail(e) {
      ...
      emailjs
        .sendForm('email', 'service_zhwywkj', formRef.current, 'service_zhwywkj')
        .then(
          (result) => {
            ...
            <div className=' box-shadow'>
                    <div>
                        ...
                        <center> 
                               ...
                               <div className=' my-logo twitter'>
                                     <a className='icons ' href="/" target='_blank'>
                                    ...
                                    <a className='icons text-dark git-hub' href="/">
                                    ...
                                    <Link className='icons linkedln' path to="/">
                                     ...
                                     <Link className='icons text-success what-app ' path to="/">
                ...
                <form ref={formRef}  onSubmit={sendEmail}>
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="name" name="name" placeholder="john doe/jane doe"/>
                    </div>
                    <div className="form-group">
                    ...
                    <center> <input className="btn text-danger box-shadow" type="submit" value=" Send Message"/>
